                        ...
                        children: [
                            {
                                ...
                                children: [
                                    ...
                                    },
                                    {
                                        ...
                                        meta: {title: '教练员信息'},
                                        component: () => import('@/views/main/1-coaches/mass-youth/CoachMYInfo.vue')
                                    }
                                ]
                            },
                            {
                                ...
                                children: [
                                    ...
                                    },
                                    {
                                        ...
                                        meta: {title: '教练员信息'},
                                        component: () => import('@/views/main/1-coaches/open-water/CoachOWInfo.vue')
                                    }
                                ]
                            },
                        ]
                                ...
                                children: [
                                    {
                                        ...
                                        meta: {title: '积分排名榜'},
                                        component: () => import('@/views/main/6-points/mass-youth/MYAthleteRanking.vue'),
                                    },
                                    {
                                        path: 'athletes-info',
                                    ...
                                    },
                                    {
                                        ...
                                        meta: {title: '留榜运动员名单'},
                                        component: () => import('@/views/main/6-points/mass-youth/statistic/retention/MYRetentionNameList.vue'),
                                    },
                                    {
                                        path: 'statistic/retention/number',
                                        name: 'points/mass-youth/statistic/retention/number',
                                        meta: {title: '留榜人数统计'},
                                        component: () => import('@/views/main/6-points/mass-youth/statistic/retention/MYRetentionNumber.vue'),
                                    },
                                    {
                                        path: 'statistic/retention/rate',
                                        name: 'points/mass-youth/statistic/retention/rate',
                                        meta: {title: '留榜率'},
                                        component: () => import('@/views/main/6-points/mass-youth/statistic/retention/MYRetentionRate.vue'),
                                    },
                                    {
                                        path: 'statistic/entry/name-list',
                                        name: 'points/mass-youth/statistic/entry/name-list',
                                        meta: {title: '新入榜运动员名单'},
                                        component: () => import('@/views/main/6-points/mass-youth/statistic/entry/MYEntryNameList.vue'),
                                    },
                                    {
                                        path: 'statistic/entry/number',
                                        name: 'points/mass-youth/statistic/entry/number',
                                        meta: {title: '新入榜人数统计'},
                                        component: () => import('@/views/main/6-points/mass-youth/statistic/entry/MYEntryNumber.vue'),
                                    },
                                    {
                                        path: 'statistic/entry/rate',
                                        name: 'points/mass-youth/statistic/entry/rate',
                                        meta: {title: '新入榜率'},
                                        component: () => import('@/views/main/6-points/mass-youth/statistic/entry/MYEntryRate.vue'),
                                    },
                                ]
                            },
                            {
                                ...
                                children: [
                                    {
                                        ...
                                        meta: {title: '积分排名榜'},
                                        component: () => import('@/views/main/6-points/open-water/OWAthleteRanking.vue'),
                                    },
                                    {
                                        path: 'athletes-info',
                                        name: 'points/open-water/athletes-info',
                                        meta: {title: '运动员信息'},
                                        component: () => import('@/views/main/6-points/open-water/OWAthleteInfo.vue'),
                                    }
                                ]
                            },
                        ]
